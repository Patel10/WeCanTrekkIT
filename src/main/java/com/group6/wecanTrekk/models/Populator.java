...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Continent Africa = new Continent("Africa", "/images/Africa.jpg", "Africa is the world's second-largest and second-most populous continent. It covers 6% of Earth's total surface area and 20% of its land area. \n" +
                "Trek Options: West & North Africa.\n");
        Continent Antarctica = new Continent("Antarctica", "/images/Antarctica.jpg", "Antarctica is Earth's southernmost continent. It contains the geographic South Pole and is situated in the Antarctic region of the Southern Hemisphere.  \n" +
                "Trek Options: Antarctica Peninsula & The Ross Sea!\n");
        Continent Asia = new Continent("Asia", "/images/Asia.jpg", "Asia is the largest continent on Earth. It covers 9% of the Earth's total surface area (or 30% of its land area), and has the longest coastline. \n" +
                "Trek Options: South & East Asia!\n");
        Continent Australia = new Continent("Australia", "/images/Australia.jpg", "Asia is the largest continent on Earth. It covers 9% of the Earth's total surface area (or 30% of its land area), and has the longest coastline. \n" +
                "Trek Options: South & East Asia!\n");
        Continent Europe = new Continent("Europe", "/images/Europe.jpg", "Europe is a continent located entirely in the Northern Hemisphere and mostly in the Eastern Hemisphere. \n" +
                "Trek Options: Eastern & Western Europe!\n");
        Continent NorthAmerica = new Continent("North America", "/images/North America.jpg", "North America is a continent entirely within the Northern Hemisphere and almost all within the Western Hemisphere.\n" +
                "Trek Options: Canadian Shield & The Rocky Mountains!\n");
        Continent SouthAmerica = new Continent("South America", "/images/South America.jpg", "North America is a continent entirely within the Northern Hemisphere and almost all within the Western Hemisphere.\n" +
                "Trek Options: Canadian Shield & The Rocky Mountains!\n");
        ...
        regionRepo.save(new Region("Northern Africa", "Egypt",  "/images/africa elephant.jpg",
                "Come along with us and explore the untamed regions of Egypt.", Africa));
        regionRepo.save(new Region("Western Africa", "Ghana",   "/images/africa plains.jpg",
                "Put an African trek to Ghana on your bucket list!", Africa));
        regionRepo.save(new Region("Antarctic Peninsula", "Northern Islands",   "/images/Antarctica.jpg",
                "Antarctic is a beautiful mostly unexplored continent. The Falklands will take your breath away! ", Antarctica));
        regionRepo.save(new Region("Falkland Islands", "Ross Sea", "/images/antarctica region1.jpg",
                "Make Antarctica your last frontier", Antarctica));
        regionRepo.save(new Region("South Asia", "Kashmir Valley", "/images/asia region1.jpg",
                "At We Can Trek It - We're not all about the Benjamins' You can afford us!", Asia));
        regionRepo.save(new Region("Western Asia", "China", "/images/asia region2.jpg",
                "Come home to Asia - We miss you - Kashmir Valley!", Asia));
        regionRepo.save(new Region("New South Wales", "South Eastern Australia", "/images/australia region1.jpg",
                "Go wild about Australia - Kiss a kangaroo or two!", Australia));
        regionRepo.save(new Region("Victoria", " South Australia", "/images/australia region1.jpg",
                "Don't regret no taking the Plunge!", Australia));
        regionRepo.save(new Region("Eastern Europe", "Poland", "/images/europe region1.jpg",
                "Enjoy the old world charm!", Europe));
        regionRepo.save(new Region("Western Europe", "France", "/images/europe region2jpg.jpg",
                "Now's the time to believe the best is for you!",  Europe));
        regionRepo.save(new Region("Canadian Shield", "Quebec City", "/images/north america region1.jpg",
                "Don't life get in the way of having fun!", NorthAmerica));
        regionRepo.save(new Region("Rocky Mountains", "Colorado", "/images/north america region2.jpg",
                "The Rocky Mountains is not just for 'John Denver'", NorthAmerica));
        regionRepo.save(new Region("Gran Columbia", "Venezuela", "/images/south america region1.jpg",
                " Find love! Love of the Trek in Gran Columbia!", SouthAmerica));
        regionRepo.save(new Region("Gaucho", "Chile", "/images/south america region2.jpg",
        ...
        Trekk antarctica1 = new Trekk("Falkland Islands", "Antarctic", "Northern Islands", "5", "$5,200", "/images/falkland.jpg", "Falkland Island consist of many smaller island that make for a great adventures journey. Travelers don’t always expect white sandy beaches in sub-Antarctic islands. The numerous beaches of the Falkland Islands surprise many polar travelers—especially if they’re on a voyage that includes the Antarctic Peninsula ");
        Trekk antarctica2 = new Trekk("South Georgia", "Antarctic", "Main Peninsula", "5", "$3,200", "/images/south-georgia.jpg", "Located on the north shore of South Georgia Island, Fortuna Bay is marked by rugged mountainous terrain and abundant wildlife. It’s a relatively small bay – only 3 miles (5 km) long and 1 mile (1.6 km) wide and is ideal for observing icebergs");

...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Trekk africaR1 = new Trekk("Dahab", "Egypt", "Northern Africa", "1", "$400", "/images/across-the-divide.jpg", "Dahab is one of the most rewarding hiking trails in Egypt. " +
        ...
        Trekk africaR2 = new Trekk("Mount Afadja", "Ghana", "Western Africa", "4", "$800", "/images/kashmir.jpg", "The highest mountain in West Africa offers spectacular views of both Ghana and Togo from its summit, which is accessed through a dense forest and a four-hour climb, passing three levels of waterfalls along the way. Many visitors hike Afajato and Tagbo falls.");
        ...
        Trekk antarctica1 = new Trekk("Falkland Islands", "Anatarctic", "Northern Islands", "5", "$5,200", "/images/kashmir.jpg", "Falkland Island consist of many smaller island that make for a great adventures journey. Travelers don’t always expect white sandy beaches in sub-Antarctic islands. The numerous beaches of the Falkland Islands surprise many polar travelers—especially if they’re on a voyage that includes the Antarctic Peninsula ");
        Trekk antarctica2 = new Trekk("South Georgia", "Anatarctic", "Main Peninsula", "5", "$3,200", "/images/kashmir.jpg", "Located on the north shore of South Georgia Island, Fortuna Bay is marked by rugged mountainous terrain and abundant wildlife. It’s a relatively small bay – only 3 miles (5 km) long and 1 mile (1.6 km) wide and is ideal for observing icebergs");
        Trekk australia1 = new Trekk("Kiama Coast Walk", "Australia", "New South Wales", "2", "$100", "/images/kashmir.jpg", "Kiama Coast Walk is a 12.7 mile moderately trafficked point-to-point trail located near Kiama, New South Wales, Australia that offers the chance to see wildlife and is rated as moderate. The trail is primarily used for hiking, walking, running, and mountain biking and is accessible year-round.");
        Trekk australia2 = new Trekk("Keppel Lookout Trail", "Australia", "Victoria", "2", "Free", "/images/kashmir.jpg", "Climb up through stringybark and mountain ash forest to four of Marysville's best lookouts for spectacular views across Marysville, the Cathedral Range State Park and Steavenson Falls. Keppel Lookout Trail is fairly uneven and steep in places");
        Trekk europe1 = new Trekk("Bieszczady Mountains", "Poland", "Eastern Europe", "7", "$500", "/images/kashmir.jpg", "About a dozen trails wend through the 72,000-acre Bieszczady National Park, the highlight of this colorful, rolling range that boils up to about 4,500 feet in extreme southern Poland. Ambitious hikers with plenty of time can piece together routes up to ten-days long, following trails that drop into villages and climb over “polonyna” or the high mountain meadows that make this region so famous. ");
        ...
        Trekk nAmerica = new Trekk("Across the Divide", "Colorado", "Rocky Mountains", "8", "$1,530", "/images/kashmir.jpg", "Across the Divide backpack takes us from the rivers that flow east into the Atlantic, to the very headwaters of those that make their way west to the Pacific – and we do it all under our own power! " +
        ...
        Trekk nAmerica2 = new Trekk("Montagne des Érables", "Quebec City", "Canadian Shield", "4", "Free", "/images/kashmir.jpg", "With a 2,625-foot vertical drop, this difficult trail in the Charlevoix region’s Parc national des Hautes-Gorges-de-la-Rivière-Malbaie rewards with spectacular peak and valley views. " +

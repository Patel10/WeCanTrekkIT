...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Trekk nAmerica = new Trekk("Across the Divide","Colorado","Rocky Mountains","8","$1,530","images/across-the-divide.jpg","Across the Divide backpack takes us from the rivers that flow east into the Atlantic, to the very headwaters of those that make their way west to the Pacific – and we do it all under our own power! " +
